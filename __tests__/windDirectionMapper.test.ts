...
describe('Wind Direction Mapper Tests', () => {
    it('returns arrow-down-thick for north wind', () => {
    ...
    it('returns arrow-bottom-left-thick for north east wind', () => {
    ...
    it('returns arrow-left-thick for east wind', () => {
    ...
    it('returns arrow-top-left-thick for south east wind', () => {
    ...
    it('returns arrow-up-thick for south wind', () => {
    ...
    it('returns arrow-top-right-thick for south west wind', () => {
    ...
    it('returns arrow-right-thick for west wind', () => {
    ...
    it('returns arrow-bottom-right-thick for north west wind', () => {
    ...
    it('throws an error for invalid wind direction angles', () => {
